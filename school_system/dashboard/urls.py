...
urlpatterns = [
    ...
    path('accounts/create/<str:role>/', dashboard_views.create_account_view, name='dashboard_create_account'),
    path('accounts/<int:user_id>/edit/', dashboard_views.edit_account_view, name='dashboard_edit_account'),
    ...
    path('accounts/<int:user_id>/delete/', dashboard_views.delete_account_view, name='dashboard_delete_account'),
