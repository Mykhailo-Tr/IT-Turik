...
urlpatterns = [
    ...
    path('accounts/<int:user_id>/edit/', dashboard_views.edit_account_view, name='edit_account'),
    path('accounts/<int:user_id>/delete/', dashboard_views.delete_account_view, name='delete_account'),
